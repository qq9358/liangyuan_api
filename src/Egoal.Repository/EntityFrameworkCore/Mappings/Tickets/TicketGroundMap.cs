...
{
    public class TicketGroundMap : IEntityTypeConfiguration<TicketGround>
    {
        public void Configure(EntityTypeBuilder<TicketGround> entity)
        {
            ...
            entity.ToTable("TM_TicketGround");
